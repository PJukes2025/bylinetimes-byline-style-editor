...
def apply_house_style(text):
    ...
    rules = [
        # Batch 1 — Core political and institutional fixes
        ...
        (r"\b(?<!\bthe\s)(Tories)\b", "the Conservatives"),
        (r"\b(?<!\bthe\s)(Lib Dems)\b", "the Liberal Democrats"),
        ...
        # Batch 2 — Numbers, ages, money, punctuation
        ...
        # Batch 4 — Tone, bylines, preferred phrasing
